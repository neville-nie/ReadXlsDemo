...
/**
 * XLSXCovertCSVReader.java abstract:
 * 
 * hostory: NW 2017-4-28 初始化
 */
...
/*
	...
	*//**
	 ...
	 * @throws IOException
	 */
	private static List<String[]> readerExcel(String path, String sheetName, int minColumns) throws IOException,
			OpenXML4JException, ParserConfigurationException, SAXException {
		OPCPackage p = OPCPackage.open(path, PackageAccess.READ);
		XLSXCovertCSV xlsx2csv = new XLSXCovertCSV(p, minColumns, System.out, sheetName);
